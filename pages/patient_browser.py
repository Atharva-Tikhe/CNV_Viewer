...
def run():
    ...
    only_discrepant = st.sidebar.checkbox(
        "Show only patients with discrepancies", value=False
    )
    ...
    if selected_rid:
        ...
        with col4:
            ...
            status_text = (
                ...
                if discrepancies == 1
                else f"{discrepancies} Discrepancies"
            )
        ...
        with c_left:
            ...
            disp_df = p_long[
                ["Gene", "DO_Status", "PO_Status", "Class", "Class_Label"]
            ].copy()
            disp_df.columns = [
                "Gene Name",
                "Diagnostic (DO)",
        ...
        #             value=e_comment,
        #             placeholder="Enter any validation remarks, data quality comments, or reasoning here...",
        #             height=120,
        #         )
        #
        #         submit_button = st.form_submit_button(
        #             "Save Review Notes", width="stretch"
        #         )
        #
        #         if submit_button:
        ...
        with c_right:
            ...
            st.markdown(
                """ <span ><a style="font-size:12px; color: gray" target="_blank" href='https://doi.org/10.1038/s41375-021-01448-2'>10.1038/s41375-021-01448-2</a></span>""",
                unsafe_allow_html=True,
            )
            result = ""
            ...
            st.markdown(
                f"""
          <div class="metric-card">
              <h4 style="margin:0; color:#7f8c8d; font-size:0.9rem;">Pipeline UKALL Classifier</h4>
              <p style="margin:5px 0 0 0; color:{status_color}; font-size:1.6rem; font-weight:bold;">{result}</p>
          </div>
          """,
                unsafe_allow_html=True,
            )
